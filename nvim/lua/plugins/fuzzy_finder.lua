...
return {
  ...
  config = function ()
    ...
    require('which-key').register {
      ['<leader>?'] = { name = '[?] Find recently opened files', _ = 'which_key_ignore' },
      ['<leader><space>'] = { name = '[ ] Find existing buffers', _ = 'which_key_ignore' },
      ['<leader>g'] = { name = '[G]it', _ = 'which_key_ignore' },
      ['<leader>s'] = { name = '[S]earch', _ = 'which_key_ignore' },
      ['<leader>/'] = { name = '[/] Fuzzily search in current buffer', _ = 'which_key_ignore' },
    }
